                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <button
                      ...
                      className={`p-6 rounded-[2rem] border-2 transition-all flex flex-col items-center gap-4 group relative overflow-hidden text-center ${
                        role === r.id 
                    ...
                    >
                      <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-500 ${
                        role === r.id ? `${r.color} text-white shadow-lg` : 'bg-[#1B4332]/5 text-[#1B4332]/20 group-hover:bg-[#1B4332]/10'
                      }`}>
                        <r.icon size={20} />
                      </div>
